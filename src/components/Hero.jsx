...
function Hero() {
  ...
  useGSAP(() => {
    ...
    const paragraphSplit1 = new SplitText(".subtitle1", { type: "lines " });
        ...
        <div className="body ">
          <div className="content">
            <div className="space-y-5 hidden md:block">
              <p className="pl-18 pt-12 ml-12 subtitle1">
                Cool. Crisp. Classic.
              </p>
              <p className="subtitle1 px-18 ml-12">
                Sip the Spirit <br />
                of Summer
              </p>
            </div>
            <div className="view-cocktails">
              <p className="subtitle   pt-12 ">
